...
def test_jax_batched_projection_matches_reference_scale_offset():
    ...
    jax_result = jax_engine.projection.project_single_species_batch(
        observed_matrix=observed_matrix,
        species_values=species_values,
        fit_scale=True,
        fit_offset=True,
...
def test_jax_batched_projection_matches_reference_scale_only():
    reference = get_engine_bundle("reference")
    jax_engine = get_engine_bundle("jax_projection")
...
def test_jax_batched_projection_matches_reference_offset_only():
    reference = get_engine_bundle("reference")
    jax_engine = get_engine_bundle("jax_projection")
...
def test_jax_batched_projection_missing_values_fallback_matches_reference():
    reference = get_engine_bundle("reference")
    jax_engine = get_engine_bundle("jax_projection")
